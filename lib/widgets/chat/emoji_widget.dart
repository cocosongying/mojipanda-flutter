...
import 'package:mojipanda/widgets/chat/circle_page_indicator.dart';
import 'package:mojipanda/widgets/chat/emoji_util.dart';
      ...
      child: key != 0
          ...
          : new Container(
              ...
              child: Container(
                ...
                width: 25.0,
                child: Image.asset(
                  Constant.ASSETS_IMG + "ic_emoji_delete.png",
                ),
              )),
    );
    return item;
